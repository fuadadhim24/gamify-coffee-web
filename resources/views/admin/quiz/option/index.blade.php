...
<head>
    ...
    <title>Daftar Pertanyaan - SIPKopi Admin Dashboard</title>
...
<body>
    ...
    <div id="main">
        ...
        <div class="page-heading">
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Jawaban</h3>
                        <p class="text-subtitle text-muted">Mengelola jawaban sebagai validasi pilihan yang benar pada
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Tabel Jawaban</h5>
                            <button type="button" class="btn btn-primary me-1 mb-1" data-bs-toggle="modal"
                                data-bs-target="#tambahOptionModal">Tambah</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($options as $option)
                                    <tr>
                                        ...
                                        <td>{{ $option->created_at ? $option->created_at->format('Y-m-d H:i:s') : '_' }}
                                        </td>
                                        <td>{{ $option->updated_at ? $option->updated_at->format('Y-m-d H:i:s') : '_' }}
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-sm btn-warning edit-btn"
                                                data-bs-toggle="modal"
                                                data-bs-target="#editOptionModal{{ $option->option_id }}"
                                                data-id="{{ $option->option_id }}"
                                                data-title="{{ $option->content }}">Edit</a>
                                            <form
                                                action="{{ route('admin.quiz.option.destroy', ['option' => $option->option_id]) }}"
                                    ...
                                    <!-- Modal Edit -->
                                    <div class="modal fade" id="editOptionModal{{ $option->option_id }}"
                                        tabindex="-1" aria-labelledby="editOptionModalLabel{{ $option->option_id }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="editOptionModalLabel{{ $option->option_id }}">Edit
                                                        Pertanyaan</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <form
                                                    action="{{ route('admin.quiz.option.update', ['option' => $option->option_id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                                                        ...
                                                                                        <div class="col-md-8">
                                                                                            ...
                                                                                            <div class="col-md-8">
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    class="form-control"
                                                                                                    name="content"
                                                                                                    placeholder="cth: Dipupuk menggunakan NPK"
                                                                                        ...
                                                                                        <div class="col-md-8">
                                                                                            ...
                                                                                            <fieldset
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    <option
                                                                                                        value="1"
                                                                                                        {{ $option->is_correct == 1 ? 'selected' : '' }}>
                                                                                                        Benar</option>
                                                                                                    <option
                                                                                                        value="0"
                                                                                                        {{ $option->is_correct == 0 ? 'selected' : '' }}>
                                                                                                        Salah</option>
                                                                                                </select>
                                                                                            </fieldset>
                                                                                        </div>
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    @foreach ($questions as $question)
                                                                                                        <option
                                                                                                            ...
                                                                                                            {{ $question->question_id == $option->question_id ? 'selected' : '' }}>
                                                                                                            {{ $question->content }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                </select>
            ...
            <!-- Modal add-->
            <div class="modal fade" id="tambahOptionModal" tabindex="-1" aria-labelledby="tambahOptionModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="tambahOptionModalLabel">Form Tambah Jawaban</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <form action="{{ route('admin.quiz.option.store') }}" method="POST">
                            @csrf
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
